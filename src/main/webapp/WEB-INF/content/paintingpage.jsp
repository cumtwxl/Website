...
<ul id="cd-gallery-items" class="cd-container">
	<c:forEach items="${requestScope.good }" var="good" varStatus="status">
			<c:if test="${6< good.pid}">
	<li>
		<ul class="cd-item-wrapper">
			<a href="goodshow1?pid=${good.pid }"><li class="cd-item-front"><img src="${good.pimage }" ></li></a>
			<li class="cd-item-middle"><a href="goodshow"><img src="${good.proimage }" ></a></li>
		</ul> <!-- cd-item-wrapper -->
